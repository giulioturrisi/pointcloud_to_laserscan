...
def generate_launch_description():
    return LaunchDescription([
        ...
        #            'header': {'frame_id': 'base_footprint'}, 'angle_min': 0,
        #            'angle_max': 6.2831, 'angle_increment': 0.174, 'range_max': 10.0,
        ...
        Node(
            ...
            remappings=[('scan_in','/scan'),
                        ('cloud', '/pointcloud')],
            parameters=[{'target_frame': 'base_footprint', 'transform_tolerance': 0.01}]
        ),
    ])
